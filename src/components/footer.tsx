...
const Footer = () => {
  ...
  return (
    <footer className="flex flex-col items-stretch h-[60vh] gap-16 w-full py-20 px-16 px overflow-hidden">
      {/* top */}
      ...
      <div className={`flex items-center justify-center ${theme == "dark" ? "opacity-16" : "opacity-8"}`}>
        <Image
